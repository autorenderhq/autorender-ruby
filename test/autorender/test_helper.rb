...
class Autorender::Test::SingletonClient < Autorender::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Autorender::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Autorender::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @autorender = Autorender::Test::SingletonClient.instance
  end
