...
class AutorenderTest < Minitest::Test
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/api/v1/uploads").to_return_json(
      status: 500,
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Autorender::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Autorender::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Autorender::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
