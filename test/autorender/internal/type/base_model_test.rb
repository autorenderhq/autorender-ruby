...
class Autorender::Test::PrimitiveModelTest < Minitest::Test
  A = Autorender::Internal::Type::ArrayOf[-> { Integer }]
  H = Autorender::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Autorender::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Autorender::Internal::Type::Unknown,
      Autorender::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Autorender::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Autorender::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Autorender::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Autorender::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Autorender::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Autorender::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Autorender::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Autorender::Internal::Type::Boolean, true] => true,
      [Autorender::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Autorender::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Autorender::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Autorender::Internal::Type::Converter.new_coerce_state
      Autorender::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Autorender::Internal::Type::Converter.dump(target, input, state: state)
...
class Autorender::Test::EnumModelTest < Minitest::Test
  class E0
    include Autorender::Internal::Type::Enum
...
class Autorender::Test::CollectionModelTest < Minitest::Test
  A1 = Autorender::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Autorender::Internal::Type::HashOf[Integer]

  A2 = Autorender::Internal::Type::ArrayOf[H1]
  H2 = Autorender::Internal::Type::HashOf[-> { A1 }]

  A3 = Autorender::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Autorender::Internal::Type::HashOf[Integer, nil?: true]
...
class Autorender::Test::BaseModelTest < Minitest::Test
  class M1 < Autorender::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Autorender::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Autorender::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Autorender::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Autorender::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Autorender::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Autorender::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Autorender::Errors::ConversionError => e
...
class Autorender::Test::UnionTest < Minitest::Test
  class U0
    include Autorender::Internal::Type::Union
  ...
  class M2 < Autorender::Internal::Type::BaseModel
  ...
  class M4 < Autorender::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Autorender::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Autorender::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Autorender::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Autorender::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Autorender::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Autorender::Internal::Type::Unknown, Autorender::Internal::Type::Unknown] => true,
      [Autorender::Internal::Type::Boolean, Autorender::Internal::Type::Boolean] => true,
      [Autorender::Internal::Type::Unknown, Autorender::Internal::Type::Boolean] => false,
...
class Autorender::Test::MetaInfoTest < Minitest::Test
  A1 = Autorender::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Autorender::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
