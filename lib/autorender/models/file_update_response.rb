...
module Autorender
  module Models
    ...
    class FileUpdateResponse < Autorender::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Autorender::Models::FileUpdateResponse::Data]
      required :data, -> { Autorender::Models::FileUpdateResponse::Data }

      # @!attribute success
      #
      #   @return [Boolean, Autorender::Models::FileUpdateResponse::Success]
      required :success, enum: -> { Autorender::Models::FileUpdateResponse::Success }

      # @!method initialize(data:, success:)
      #   Updated file
      #
      #   @param data [Autorender::Models::FileUpdateResponse::Data]
      #   @param success [Boolean, Autorender::Models::FileUpdateResponse::Success]

      # @see Autorender::Models::FileUpdateResponse#data
      ...
      # @see Autorender::Models::FileUpdateResponse#success
      module Success
