...
module Autorender
  module Models
    ...
    class FolderListResponse < Autorender::Internal::Type::BaseModel
      # @!attribute folders
      #
      #   @return [Array<Autorender::Models::FolderListResponse::Folder>]
      required :folders,
               -> { Autorender::Internal::Type::ArrayOf[Autorender::Models::FolderListResponse::Folder] }

      # @!method initialize(folders:)
      #   List of folders
      #
      #   @param folders [Array<Autorender::Models::FolderListResponse::Folder>]
