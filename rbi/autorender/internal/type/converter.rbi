  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Autorender::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Autorender::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Autorender::Internal::Type::Converter::Input,
              value: T.anything,
              state: Autorender::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
